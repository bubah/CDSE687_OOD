...
public:
	...
	FileManagement(string inputD, string tmpD = "", string outputD = ""); //Constructor with 3 params
	void writeToInputFile(string inputFileName, string fileContent);

	string readFromInputFile(string inputFileName);
	void writeToTmpFile(const string tmpFileName, const string fileContent);
